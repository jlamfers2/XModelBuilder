...
/// <summary>
/// The primary <see cref="Customer"/> builder (role Customer). This is the showcase for
/// <c>[ModelBuilder(name)]</c> - several specific builders for the same model type, addressed by
/// name/type - together with the <see cref="WarehouseCustomerBuilder"/> and
/// <see cref="AdminCustomerBuilder"/> variants. Filler name/email come from the seeded
/// <see cref="BogusFaker"/> (locale "nl"), so they are realistic yet deterministic.
/// </summary>

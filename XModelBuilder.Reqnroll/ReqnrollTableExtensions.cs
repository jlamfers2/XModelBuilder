...
/// <item>
/// <description>
/// Vertical "Field/Value" tables (exactly two columns): every row describes one member of a
/// SINGLE instance, e.g.
/// <code>
/// | Field | Value     |
/// | Name  | John      |
...
/// <item>
/// <description>
/// Horizontal tables (any other column count): the header row holds the member names and
/// every data row describes one instance, e.g.
/// <code>
/// | Name | City      |
/// | John | Amsterdam |
/// | Jane | Utrecht   |
...
/// </summary>
public static class ReqnrollTableExtensions
{
    ...
    /// <summary>
    /// Configures the Reqnroll table integration - currently the language-dependent vertical
    ...
    /// </code>
    /// </summary>
    public static void Configure(Action<ReqnrollTableOptions> configure)
    {
        ArgumentNullException.ThrowIfNull(configure);

        var options = new ReqnrollTableOptions
        {
